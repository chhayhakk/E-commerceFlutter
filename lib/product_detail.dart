...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void initState() {
    ...
    productController.fetchProductById(widget.productId, userData['id']);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (productController.productDetails.value == null) {
          return Center(child: CircularProgressIndicator());
        }
        final productDetail = productController.productDetails.value!;
        final userData = userController.userData.value!;
        bool isFavorite = productDetail['is_favorite'];
                ...
                Stack(
                  children: [
                    Container(
                        ...
                        child: Image(
                          image: AssetImage(
                              'assets/products/${productDetail['image']}'),
                          fit: BoxFit.contain,
                          width: 300,
                          height: 300,
                        )),
